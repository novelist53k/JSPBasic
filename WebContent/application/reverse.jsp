...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	if(session.getAttribute("authYN") == null) response.sendRedirect("auth.jsp");

	// application 객체의 예약정보를 얻는다.
	List<String> list = new ArrayList<>();
	if(application.getAttribute("seat") != null) list = (List<String>)application.getAttribute("seat");
...
<body>
	...
	input 태그에 반드시 값을 입력하라는 옵션 required
